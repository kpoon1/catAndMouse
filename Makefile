...
OBJS= alienattack.o attack.o Audio.o HealthBar.o bigMap.o character.o chest.o damageTrap.o entity.o grid.o helper.o hidingPlace.o interactable.o InteractableManager.o Inventory.o item.o locker.o Menu.o network.o stickyTrap.o Table.o Timer.o trap.o main.o
